...
DROP TABLE IF EXISTS User_Badges, Badges, Feedback_Responses, User_Tasks, User_Plans, Template_Tasks, Template_Stages, Templates, Users CASCADE;
...
-- === ДАННЫЕ ===
INSERT INTO Users (id, name, email, password_hash, role, position, department) VALUES
('11111111-1111-1111-1111-111111111111', 'Иван Смирнов', 'ivan@naumen.ru', 'password123', 'newbie', 'Java Разработчик', 'Разработка'),
('22222222-2222-2222-2222-222222222222', 'Анна HR', 'anna@naumen.ru', 'password123', 'hr', 'HR Business Partner', 'HR отдел'),
('33333333-3333-3333-3333-333333333333', 'Алексей Наставник', 'alexey@naumen.ru', 'password123', 'mentor', 'Senior Developer', 'Разработка');

-- Шаблон
INSERT INTO Templates (id, name) VALUES ('44444444-4444-4444-4444-444444444444', 'Java Developer Onboarding');
...
-- Моковые пользователи (10 человек)
INSERT INTO Users (name, email, password_hash, role, position, department) VALUES
('Дмитрий Волков', 'd.volkov@mock.test', 'password123', 'newbie', 'Frontend Dev', 'Разработка'),
('Анна Морозова', 'a.morozova@mock.test', 'password123', 'newbie', 'Backend Dev', 'Разработка'),
('Сергей Лебедев', 's.lebedev@mock.test', 'password123', 'newbie', 'QA Engineer', 'Тестирование'),
('Ольга Соколова', 'o.sokolova@mock.test', 'password123', 'newbie', 'Analyst', 'Аналитика'),
('Андрей Козлов', 'a.kozlov@mock.test', 'password123', 'newbie', 'DevOps', 'Инфраструктура'),
('Елена Новикова', 'e.novikova@mock.test', 'password123', 'newbie', 'UX Designer', 'Дизайн'),
('Павел Федоров', 'p.fedorov@mock.test', 'password123', 'newbie', 'Frontend Dev', 'Разработка'),
('Марина Петрова', 'm.petrova@mock.test', 'password123', 'newbie', 'Backend Dev', 'Разработка'),
('Иван Егоров', 'i.egorov@mock.test', 'password123', 'newbie', 'QA Engineer', 'Тестирование'),
('Екатерина Смирнова', 'e.smirnova@mock.test', 'password123', 'newbie', 'PM', 'Менеджмент')
ON CONFLICT (email) DO NOTHING;

-- Планы, задачи, пульс для моковых
INSERT INTO User_Plans (user_id, template_id, mentor_id, status, total_xp, current_level)
SELECT u.id, '44444444-4444-4444-4444-444444444444', '33333333-3333-3333-3333-333333333333', 'in_progress', (random() * 100)::int, 1
