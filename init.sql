...
-- === ДАННЫЕ ===
INSERT INTO Users (id, name, email, password, role, position, department) VALUES
('11111111-1111-1111-1111-111111111111', 'Иван Смирнов', 'ivan@naumen.ru', '$2a$10$hashivan', 'newbie', 'Java Разработчик', 'Разработка'),
('22222222-2222-2222-2222-222222222222', 'Анна HR', 'anna@naumen.ru', '$2a$10$hashanna', 'hr', 'HR Business Partner', 'HR отдел'),
('33333333-3333-3333-3333-333333333333', 'Алексей Наставник', 'alexey@naumen.ru', '$2a$10$hashalexey', 'mentor', 'Senior Developer', 'Разработка')
...
INSERT INTO Users (name, email, password, role, position, department) VALUES
('Дмитрий Волков', 'd.volkov@mock.test', 'hash', 'newbie', 'Frontend Dev', 'Разработка'),
('Анна Морозова', 'a.morozova@mock.test', 'hash', 'newbie', 'Backend Dev', 'Разработка'),
('Сергей Лебедев', 's.lebedev@mock.test', 'hash', 'newbie', 'QA Engineer', 'Тестирование'),
('Ольга Соколова', 'o.sokolova@mock.test', 'hash', 'newbie', 'Analyst', 'Аналитика'),
('Андрей Козлов', 'a.kozlov@mock.test', 'hash', 'newbie', 'DevOps', 'Инфраструктура'),
('Елена Новикова', 'e.novikova@mock.test', 'hash', 'newbie', 'UX Designer', 'Дизайн'),
('Павел Федоров', 'p.fedorov@mock.test', 'hash', 'newbie', 'Frontend Dev', 'Разработка'),
('Марина Петрова', 'm.petrova@mock.test', 'hash', 'newbie', 'Backend Dev', 'Разработка'),
('Иван Егоров', 'i.egorov@mock.test', 'hash', 'newbie', 'QA Engineer', 'Тестирование'),
('Екатерина Смирнова', 'e.smirnova@mock.test', 'hash', 'newbie', 'PM', 'Менеджмент');
